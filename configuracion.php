                ...
                <div class="config-container">
                    <div class="config-card">
                        ...
                        <div class="config-header">
                            <h2 class="config-title">Configuración del Sistema</h2>
                        ...
                        <div class="config-body">
                                ...
                                <div class="config-grid">
                                    ...
                                    <div class="config-item">
                                        ...
                                        <select class="form-select" id="idioma">
                                            ...
                                            <option value="en" <?php echo $configuracion['idioma'] == 'en' ? 'selected' : ''; ?>>Inglés</option>
                                        </select>
                                    </div>
                            ...
                            <div class="config-section">
                                ...
                                <div class="config-grid">
                                    <div class="config-item">
                                        <div class="item-info">
                                            <h6>Auto-guardado</h6>
                                            <p>Guardar automáticamente los cambios en formularios</p>
                                        </div>
                                        <div class="form-check form-switch">
                                    ...
                                    <div class="config-item">
                                        <div class="item-info">
                                            ...
                                            <p>Mostrar tutorial de uso al iniciar sesión</p>
                                        </div>
                                        <div class="form-check form-switch">
                                    ...
                                    <div class="config-item">
                                        ...
                                        <select class="form-select" id="zonaHoraria">
                                            <option value="America/Mexico_City" <?php echo $configuracion['zona_horaria'] == 'America/Mexico_City' ? 'selected' : ''; ?>>Ciudad de México</option>
                            ...
                            <div class="danger-zone">
                                ...
                                <p class="text-danger mb-4">Estas acciones son irreversibles. Por favor, proceda con precaución.</p>
                                
                                <div class="danger-buttons">
                                    <button class="btn btn-outline-danger" id="limpiarCache">
                                        <i class='bx bx-trash'></i> Limpiar Cache del Sistema
                                    </button>
                                    
                                    <button class="btn btn-outline-danger" id="reiniciarEstadisticas">
                                        <i class='bx bx-reset'></i> Reiniciar Estadísticas
                                    </button>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button class="btn btn-outline-secondary" id="restablecerConfig">
                                    <i class='bx bx-reset'></i> Restablecer Configuración
                                </button>
                                
                                <div class="d-flex gap-3">
                                    <button class="btn btn-secondary" id="exportarConfig">
                                        <i class='bx bx-export'></i> Exportar Configuración
                                    </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        ...
                        <li>Tus reportes y estadísticas se perderán</li>
                        <li>No podrás recuperar el acceso al sistema</li>
                    </ul>
