...
insert  into `datosacademicosmaestros`(`id_datoAcademicoMaestro`,`numEmpleado`,`id_gradoEstudio`,`especialidad`,`numCedulaProfesional`,`certificacionesoCursos`,`experienciaDocente`) values (7,'M1',1,'historia','NCP1','muchos de todo','cinco años tal vez 10'),(8,'M2',2,'geografia','NCP2','muchos de todo','cinco años tal vez 10'),(9,'M3',3,'fisica','NCP3','muchos de todo','cinco años tal vez 10');
...
insert  into `discapacidades`(`id_discapacidad`,`tipoDiscapacidad`) values (1,'Discapacidad visual'),(2,'Discapacidad auditiva'),(3,'Discapacidad motriz');
...
insert  into `estados`(`id_estado`,`nombreEstado`) values (1,'Nuevo Leon'),(2,'Jalisco'),(3,'Tamaulipas'),(4,'Cohahuila');
